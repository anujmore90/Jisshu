...
BOT_TOKEN = environ.get('BOT_TOKEN', '7299239725:AAH3tHNx5BE4E2DG0zdkqJ8x8YVZq_giWMk')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8047797327').split()]
USERNAME = environ.get('USERNAME', "https://t.me/undefine_123") # ADMIN USERNAME
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002482323036'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002482323036'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002477962995')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002335921221'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002482323036')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+y-tAxthfe2k3MDJl') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/ajq.jpg')).split()
